...
import { Mail, KeyRound, AlertCircle, Eye, EyeOff, Sparkles, Share2 } from "lucide-react";
      ...
      <div className="col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-12 py-12 relative z-10 h-full">
        <div className="w-full max-w-sm mx-auto space-y-6">
          ...
          <GlassCard hoverEffect={false} className="border border-glass-border p-7 bg-slate-950/20 shadow-2xl">
            {error && (
              <div className="mb-4.5 flex items-start gap-2.5 rounded-xl bg-rose-500/5 border border-rose-500/20 p-3 text-[11px] text-rose-300">
